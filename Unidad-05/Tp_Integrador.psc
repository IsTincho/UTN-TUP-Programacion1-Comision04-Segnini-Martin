Proceso TP_Integrador
	...
	Definir lista, cuil, subCuil Como Caracter
	Definir validado,validado2 Como Logico
	Escribir "Defina la cantidad de empleados a ingresar."
	Leer cantEmpleados
...
SubProceso modificarTelefono(lista,cantEmpleados)
    ...
    Para i<-0 Hasta cantEmpleados-1 Hacer
        Si lista[i,1] = CuilBuscar
            ...
            Leer lista[posicion,1]
            lista[posicion, 1] = lista[i,1]
			Escribir ""
			Escribir "Se le ha cambiado el numero de telefono a ", lista[i,0]
			Escribir "Su nuevo numero es ", lista[i,1]
			Escribir ""
        SiNo
            encontrado=Falso
        FinSi
